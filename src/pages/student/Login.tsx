  ...
  const handleLogin = async (e) => {
    ...
    if (isEmail) {
      ...
      if (profile.login_count >= 3) {
        alert('You have exceeded the number of logins with your email. Please use your matric number.');
      ...
      // Logic for logging in with matric number
    }
